...
def cross_validate(train_data, train_label, val_data, val_label, is_masking, args):
    is_mask = is_masking
    batch = 30
    dropout_prob = 0.5
    epochs = 100
    ...
    return train_accur, valid_accur
