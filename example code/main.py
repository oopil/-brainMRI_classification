...
def parse_args():
    ...
    parser.add_argument('--gpu', type=str, default='0', help='the number of gpu to use')
    parser.add_argument('--phase', type=str, default='train', help='train or test ?')
    parser.add_argument('--dataset', type=str, default='celebA', help='[mnist / cifar10 / celebA]')
    parser.add_argument('--gen', type=str, default='generator', help='[mnist / cifar10 / celebA]')

    parser.add_argument('--resblock_num', type=int, default=3, help='The number of resblock number in generator')
    parser.add_argument('--epoch', type=int, default=20, help='The number of epochs to run')
    parser.add_argument('--iteration', type=int, default=200, help='The number of training iterations')
    parser.add_argument('--batch_size', type=int, default=36, help='The size of batch per gpu')
    parser.add_argument('--load_size', type=int, default=10000, help='The size of load on data')
    ...
    parser.add_argument('--z_dim', type=int, default=128, help='Dimension of noise vector') # do not need this
    parser.add_argument('--attention', type=str2bool, default=False, help='using attention mechanism')
    ...
    parser.add_argument('--sample_num', type=int, default=36, help='The number of sample images')
